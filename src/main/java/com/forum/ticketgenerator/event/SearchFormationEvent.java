...
public class SearchFormationEvent extends ComponentEvent<Button> {

    private List<PosteMatching> postesMatching;

    public SearchFormationEvent (Button source, boolean fromClient, List<PosteMatching> postesMatching) {
